...
export default function FirstScreenPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#e6e8ee] p-4">
      <section className="flex h-[800px] w-[1280px] flex-col items-center rounded-2xl border border-[#d0d6e3] bg-[#e6e8ee] px-14 py-8 shadow-xl">
        ...
        <div className="mb-8 grid w-[85%] grid-cols-2 gap-6">
          <Link
            href="/new"
            className="grid h-20 place-items-center rounded-2xl bg-[#c8922a] text-3xl font-extrabold text-white transition hover:brightness-95"
          >
            진단 시작하기
          </Link>
          <Link
