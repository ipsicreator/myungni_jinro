    ...
    <main className="flex min-h-screen items-center justify-center bg-[#e9ebf1] p-4">
      <section className="grid h-[800px] w-[1280px] grid-cols-[38%_38%_24%] overflow-hidden rounded-2xl border border-[#cfd5e2] bg-[#f3f5f9] shadow-xl">
        ...
        <section className="flex flex-col border-r border-[#d6dbe6] bg-white">
          ...
          <form className="grid flex-1 gap-3 overflow-auto p-4">
            <label className="grid gap-1">
              <span className="text-sm font-semibold text-[#3e4f76]">학생 이름</span>
              <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="홍길동" />
            </label>
            <label className="grid gap-1">
              <span className="text-sm font-semibold text-[#3e4f76]">학교명</span>
              <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="수프리마중학교" />
            </label>
            <div className="grid grid-cols-2 gap-2">
              <label className="grid gap-1">
                <span className="text-sm font-semibold text-[#3e4f76]">학년</span>
                <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="중2" />
              </label>
              <label className="grid gap-1">
                <span className="text-sm font-semibold text-[#3e4f76]">계열</span>
                <select className="h-10 rounded-md border border-[#cfd5e0] px-3">
                  <option>인문</option>
                  <option>자연</option>
                </select>
              </label>
            ...
            <label className="grid gap-1">
              ...
              <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="010-1234-5678" />
            </label>
            <label className="grid gap-1">
              <span className="text-sm font-semibold text-[#3e4f76]">보호자 연락처</span>
              <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="010-9876-5432" />
            </label>
            <div className="grid grid-cols-2 gap-2">
              <label className="grid gap-1">
                <span className="text-sm font-semibold text-[#3e4f76]">생년월일</span>
                <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="YYYY.MM.DD" />
              </label>
              <label className="grid gap-1">
            ...
            <label className="grid gap-1">
              ...
              <input className="h-10 rounded-md border border-[#cfd5e0] px-3" placeholder="HH:MM" />
            </label>
            <Link
              href="/questionnaire"
              className="mt-2 grid h-12 place-items-center rounded-md bg-[#c8922a] text-2xl font-bold text-white hover:brightness-95"
            >
              진단 시작하기
            </Link>
          </form>
        ...
        <aside className="flex flex-col bg-[#f5f7fb]">
          <header className="border-b border-[#d6dbe6] px-5 py-5">
            ...
            <div className="mt-2 flex items-center gap-2 text-lg font-bold text-[#1f326a]">
              <span className="grid h-7 w-7 place-items-center rounded-full bg-[#1f326a] text-sm text-white">
                1
              </span>
              기본 정보 등록
            </div>
